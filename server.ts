      ...
      if (process.env.EMAIL_USER && process.env.EMAIL_PASS) {
        try {
          ...
          if (emailError.message.includes('535')) {
            helpfulMessage = "Invalid login. If using Gmail, please use an 'App Password' from myaccount.google.com/security";
          }
      ...
      if (process.env.EMAIL_USER && process.env.EMAIL_PASS) {
        ...
        try {
          ...
          if (verifyError.message.includes('535')) {
            helpfulMessage = "Lead captured (Email delivery failed: Invalid login. If using Gmail, please use an 'App Password' from myaccount.google.com/security)";
          }
