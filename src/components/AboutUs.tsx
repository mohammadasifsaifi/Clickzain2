        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeIn direction="right" className="relative">
            ...
            >
              ...
              <div className="relative rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl shadow-brand-primary/10 aspect-[3/4] md:aspect-auto max-w-md mx-auto lg:mx-0">
                <motion.img 
                  animate={{ 
                    y: [0, -15, 0],
                  }}
                ...
                <div className="absolute bottom-8 left-8 right-8 glass p-6 rounded-2xl border border-white/10">
                  <h3 className="text-xl font-bold text-white mb-1">Mohammad Asif Saifi</h3>
                  <p className="text-brand-primary text-sm font-bold uppercase tracking-widest">Founder & CEO</p>
                </div>
              </div>
              ...
              <motion.div 
                ...
                className="absolute -top-6 -right-4 md:right-0 glass p-4 rounded-2xl z-20 border border-brand-primary/30"
              >
              ...
              <motion.div 
                ...
                className="absolute top-1/3 -left-12 glass p-4 rounded-2xl z-20 border border-white/10 hidden md:block"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-white">Data-Driven</div>
                    <div className="text-[10px] font-bold text-white/40 uppercase tracking-widest">Strategies</div>
                  </div>
                </div>
              </motion.div>
            </motion.div>
