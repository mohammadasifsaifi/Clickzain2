      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-2xl glass rounded-[3rem] border-white/10 p-12 overflow-hidden"
          >
            <button 
              onClick={onClose}
            ...
            <div className="text-center mb-12">
              <h2 className="text-4xl font-display font-bold mb-4">Download Brand Assets</h2>
              <p className="text-white/50">Get the official ClickZain logo for your marketing materials.</p>
            </div>

            <div className="flex flex-col items-center gap-12">
              <div className="w-64 h-64 rounded-[2rem] bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden relative group">
                {loading ? (
                  <div className="flex flex-col items-center gap-4">
                    <div className="w-12 h-12 border-4 border-brand-primary border-t-transparent rounded-full animate-spin" />
                    <span className="text-xs font-bold text-brand-primary uppercase tracking-widest">Generating...</span>
                  </div>
                ) : logoUrl ? (
                ...
                {logoUrl && !loading && (
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <span className="text-xs font-bold uppercase tracking-widest">Official Asset</span>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 w-full">
                <button 
                  ...
                  className="btn-primary py-5 flex items-center justify-center gap-3 disabled:opacity-50"
                >
                ...
                <button 
                  ...
                  disabled={loading || !logoUrl}
                  className="glass py-5 flex items-center justify-center gap-3 hover:bg-white/10 transition-colors disabled:opacity-50"
                >
                  <ArrowRight className="w-5 h-5 rotate-90" />
                  Download GIF
                </button>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-brand-primary selection:text-black relative">
      ...
      {/* Hero Section */}
      <Section className="pt-40 pb-20 relative z-10" onMouseMove={handleMouseMove}>
        <motion.div 
          style={{ 
            rotateX,
            rotateY,
        ...
        >
          {/* Background Glows */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-brand-primary/5 blur-[200px] rounded-full -z-10 animate-pulse pointer-events-none" />
          
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <FadeIn direction="right" className="z-30">
              <h1 className="text-5xl md:text-7xl xl:text-8xl font-display font-black leading-[0.9] mb-8 text-left tracking-tighter">
                GROW YOUR <br />
                <span className="gradient-text">BUSINESS</span> <br />
                DIGITALLY.
              </h1>
              
              <p className="text-lg md:text-xl text-white/50 mb-12 leading-relaxed text-left max-w-xl font-light">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <button 
                  onClick={() => setIsLeadModalOpen(true)}
                  className="relative group px-10 py-5 bg-brand-primary text-black font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(180,255,0,0.3)] w-full sm:w-auto"
                >
                ...
                >
                  <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:border-brand-primary/50 transition-colors">
                    <Zap className="w-5 h-5 text-white/40 group-hover:text-brand-primary transition-colors" />
                  </div>
                  <span className="text-sm font-bold text-white/40 group-hover:text-white transition-colors uppercase tracking-widest">View Case Studies</span>
                </div>
              </div>

              {/* Trust Badges */}
              <div className="mt-16 flex flex-wrap items-center gap-8 opacity-30 grayscale hover:grayscale-0 transition-all duration-500">
